...
public class BaguetteItemService {
    ...
    @Autowired
    public BaguetteItemService(BaguetteItemRepository baguetteItemRepository, BaguetteOrderRepository baguetteOrderRepository, CustomerRepository customerRepository, ItemRepository itemRepository) {
